...
from paddleseg.models.cbam import CBAM
...
class UHRNet(nn.Layer):
    ...
    def __init__(self,
        ...
        #####
        self.cbam_tr5 = CBAM(stage5_num_channels[-1])
        self.cbam_tr6 = CBAM(stage6_num_channels[-1])
        self.cbam_tr7 = CBAM(stage7_num_channels[-1])

        self.cbam_skip21 = CBAM(stage2_num_channels[-1])
        self.cbam_skip31 = CBAM(stage3_num_channels[-1])
        self.cbam_skip41 = CBAM(stage4_num_channels[-1])
    ...
    def forward(self, x):
        ...
        st2 = self.st2(tr1)
        skip21 = st2[0]
        skip21 = self.cbam_skip21(skip21)

        tr2 = self.tr2(st2[-1])
        st3 = self.st3(tr2)
        skip31 = st3[0]
        skip31 = self.cbam_skip31(skip31)

        tr3 = self.tr3(st3[-1])
        st4 = self.st4(tr3)
        skip41 = st4[0]
        skip41 = self.cbam_skip41(skip41)
